...
public class hashtags extends Configured implements Tool {
	...
	public static class HashtagsMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
	...
	public static class HashtagsReducer extends Reducer<Text, IntWritable, Text, IntWritable> {
